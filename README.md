...
Spring-Boot-Backend als OAuth2 Resource Server und einem React-SPA-Frontend.

Funktionsumfang der Baseline:

- Login / Logout über Keycloak
...
Voraussetzung: **Docker Desktop** _oder_ **Podman**.
